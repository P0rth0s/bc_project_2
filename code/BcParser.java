...
public class BcParser extends Parser {
	...
	public static class RetContext extends Adv_exprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BcListener ) ((BcListener)listener).enterRet(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BcListener ) ((BcListener)listener).exitRet(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BcVisitor ) return ((BcVisitor<? extends T>)visitor).visitRet(this);
			else return visitor.visitChildren(this);
		}
	}
